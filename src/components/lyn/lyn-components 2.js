...
export const Experience = (props) =>{
  ...
  return(
    <div className='section-lyn' id='experience-lyn'>
      <h1 className='section-title_lyn' id='experience-title_lyn'>Experience</h1>  
...
export const Education = (props) =>{
  ...
  return(
    <div className='section-lyn' id='education-lyn'>
      <h1 className='section-title_lyn' id='experience-title_lyn'>Education</h1>
...
export const More =(props) =>{
  return(
    <div className='section-lyn' id='more-lyn'>
      <h1 className='section-title_lyn' id='more-title_lyn'>More</h1>
